...
// Placement of the 1st 'Pixel Detector' to the world: Put the 'global envelop'
   ...
   rotMtrx_LogV_PixEnvG.rotateZ(45.*deg);
   ...
   new G4PVPlacement(trans3D_LogV_PixEnvG, "PhysVol_PixEnvG_#", logVol_PixEnvG, physVol_World,false, copyNum_LogV_PixEnvG,true);

   //Placement of the 2nd 'Pixel Detector' to the world: Put the 'global envelop'
   pos_X_LogV_PixEnvG = -1.*cm;
   threeVect_LogV_PixEnvG = G4ThreeVector(pos_X_LogV_PixEnvG,pos_Y_LogV_PixEnvG,pos_Z_LogV_PixEnvG);
   ...
   new G4PVPlacement(trans3D_LogV_PixEnvG,"PhysVol_PixEnvG_#2",logVol_PixEnvG,physVol_World,false,copyNum_LogV_PixEnvG,true);
